        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            <div className="p-6 bg-gray-800 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="200">
              <p className="text-gray-300">"SciDyllics automated our lead generation process, increasing conversions by 40%!"</p>
            ...
            <div className="p-6 bg-gray-800 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="400">
              <p className="text-gray-300">"Their AI chatbots saved us thousands in customer support costs!"</p>
            ...
            <div className="p-6 bg-gray-800 rounded-lg shadow-lg" data-aos="fade-up" data-aos-delay="600">
              <p className="text-gray-300">"AI-driven content marketing boosted our SEO rankings in just three months."</p>
